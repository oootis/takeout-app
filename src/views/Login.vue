        ...
        <form @submit.prevent="login">
          <div :class="{on: loginWay}">
            <section class="login-message">
              ...
              <button :disabled="!rightPhone" class="get-verification" :class="{right_phone:rightPhone}" @click.prevent="getCode">{{computeTime>0 ? `(${computeTime}s)已发送` : '获取验证码'}}</button>
            </section>
            ...
            <section>
              ...
              <section class="login-verification">
                ...
                <div class="switch-button" :class="showPwd?'on':'off'" @click="showPwd=!showPwd">
                  ...
                  <span class="switch-text">{{showPwd ? '123' : '...'}}</span>
                </div>
              </section>
              <section class="login-message">
